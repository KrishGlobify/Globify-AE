...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/process-automation", languages: {
      'en-AE': 'https://globify.ae/process-automation',
      'en-IN': 'https://globify.in/process-automation',
      'x-default': 'https://globify.ae/process-automation'
    } },
};
