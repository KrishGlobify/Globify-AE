...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/prestashop-development", languages: {
      'en-AE': 'https://globify.ae/prestashop-development',
      'en-IN': 'https://globify.in/prestashop-development',
      'x-default': 'https://globify.ae/prestashop-development'
    } },
};
