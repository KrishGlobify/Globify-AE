      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": "https://www.globify.ae/case-study/judith-leiber",
          })
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "BreadcrumbList",
            "itemListElement": [{"@type":"ListItem","position":1,"name":"Home","item":"https://www.globify.ae"},{"@type":"ListItem","position":2,"name":"Case study","item":"https://www.globify.ae/case-study"},{"@type":"ListItem","position":3,"name":"Judith leiber","item":"https://www.globify.ae/case-study/judith-leiber"}]
          })
        }}
      />
      {children}
