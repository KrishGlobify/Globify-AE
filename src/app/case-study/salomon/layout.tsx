...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/case-study/salomon", languages: {
      'en-AE': 'https://globify.ae/case-study/salomon',
      'en-IN': 'https://globify.in/case-study/salomon',
      'x-default': 'https://globify.ae/case-study/salomon'
    } },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": "https://globify.ae/case-study/salomon",
          })
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "BreadcrumbList",
            "itemListElement": [{"@type":"ListItem","position":1,"name":"Home","item":"https://globify.ae"},{"@type":"ListItem","position":2,"name":"Case study","item":"https://globify.ae/case-study"},{"@type":"ListItem","position":3,"name":"Salomon","item":"https://globify.ae/case-study/salomon"}]
          })
        }}
      />
      {children}
