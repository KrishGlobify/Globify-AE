      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": "https://www.globify.ae/case-study/ekasys-erp",
          })
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "BreadcrumbList",
            "itemListElement": [{"@type":"ListItem","position":1,"name":"Home","item":"https://www.globify.ae"},{"@type":"ListItem","position":2,"name":"Case study","item":"https://www.globify.ae/case-study"},{"@type":"ListItem","position":3,"name":"Ekasys erp","item":"https://www.globify.ae/case-study/ekasys-erp"}]
          })
        }}
      />
      {children}
