...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/resources", languages: {
      'en-AE': 'https://globify.ae/resources',
      'en-IN': 'https://globify.in/resources',
      'x-default': 'https://globify.ae/resources'
    } },
};
