...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.globify.ae/shopify-netherlands" },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "BreadcrumbList",
            "itemListElement": [{"@type":"ListItem","position":1,"name":"Home","item":"https://www.globify.ae"},{"@type":"ListItem","position":2,"name":"Shopify netherlands","item":"https://www.globify.ae/shopify-netherlands"}]
          })
        }}
      />
      {children}
