...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/magento-development", languages: {
      'en-AE': 'https://globify.ae/magento-development',
      'en-IN': 'https://globify.in/magento-development',
      'x-default': 'https://globify.ae/magento-development'
    } },
};
