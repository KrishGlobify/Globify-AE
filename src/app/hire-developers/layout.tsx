...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.globify.ae/hire-developers" },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            "itemListElement": [{"@type":"ListItem","position":1,"name":"Home","item":"https://www.globify.ae"},{"@type":"ListItem","position":2,"name":"Hire developers","item":"https://www.globify.ae/hire-developers"}]
          })
        }}
      />
      {children}</>;
