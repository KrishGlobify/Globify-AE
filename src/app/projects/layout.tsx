...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/projects", languages: {
      'en-AE': 'https://globify.ae/projects',
      'en-IN': 'https://globify.in/projects',
      'x-default': 'https://globify.ae/projects'
    } },
};
