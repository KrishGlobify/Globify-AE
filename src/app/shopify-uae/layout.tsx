...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/shopify-uae", languages: {
      'en-AE': 'https://globify.ae/shopify-uae',
      'en-IN': 'https://globify.in/shopify-uae',
      'x-default': 'https://globify.ae/shopify-uae'
    } },
};
