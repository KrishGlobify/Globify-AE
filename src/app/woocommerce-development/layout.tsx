...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.globify.ae/woocommerce-development" },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            "itemListElement": [{"@type":"ListItem","position":1,"name":"Home","item":"https://www.globify.ae"},{"@type":"ListItem","position":2,"name":"Woocommerce development","item":"https://www.globify.ae/woocommerce-development"}]
          })
        }}
      />
      {children}</>;
