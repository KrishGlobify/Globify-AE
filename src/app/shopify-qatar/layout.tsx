...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.globify.ae/shopify-qatar" },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "BreadcrumbList",
            "itemListElement": [{"@type":"ListItem","position":1,"name":"Home","item":"https://www.globify.ae"},{"@type":"ListItem","position":2,"name":"Shopify qatar","item":"https://www.globify.ae/shopify-qatar"}]
          })
        }}
      />
      {children}
