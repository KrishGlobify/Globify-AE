...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/shopify-qatar", languages: {
      'en-AE': 'https://globify.ae/shopify-qatar',
      'en-IN': 'https://globify.in/shopify-qatar',
      'x-default': 'https://globify.ae/shopify-qatar'
    } },
};
