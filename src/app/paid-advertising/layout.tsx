...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/paid-advertising", languages: {
      'en-AE': 'https://globify.ae/paid-advertising',
      'en-IN': 'https://globify.in/paid-advertising',
      'x-default': 'https://globify.ae/paid-advertising'
    } },
};
