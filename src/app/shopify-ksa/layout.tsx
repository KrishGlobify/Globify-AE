...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://globify.ae/shopify-ksa", languages: {
      'en-AE': 'https://globify.ae/shopify-ksa',
      'en-IN': 'https://globify.in/shopify-ksa',
      'x-default': 'https://globify.ae/shopify-ksa'
    } },
};
